# Geparkeerd: geen openbaar e-mailadres gevonden

Deze bedrijven kwamen door de kwaliteitscheck, maar publiceren nergens een
e-mailadres: niet op hun eigen site, niet in de bedrijfsvermeldingen, niet
op hun social media. Ze staan daarom NIET op het bord.

Staande regel sinds 25-08-2026: **een kaart zonder geverifieerd, openbaar
e-mailadres wordt niet geschreven.** Het bord is er om te versturen; een
kaart waar je zelf nog een adres bij moet zoeken kost tijd in plaats van
dat het tijd bespaart.

Zoekopdrachten uitgevoerd per bedrijf: naam + plaats + "e-mail", naam +
"gmail/hotmail/outlook", naam + eigenaarsnaam. Alle drie zonder resultaat.

| Bedrijf | Plaats | Wat er wel is | Datum gecheckt |
|---|---|---|---|
| Nailbar Aukje | onbekend | wixsite + WhatsApp 06-83563890 | 2026-08-25 |
| Beautybar Westerbork | Westerbork | beautybarwesterbork.nl + Instagram | 2026-08-25 |
...
| Mark Koomen bestratingen | Lutjewinkel | gidsvermelding, KvK 85334774 (2022) HERJAAGD 31-08 (lane D): stratenmakersgids meldt expliciet geen e-mailadres en geen website. | 2026-08-25, herjaagd 2026-08-31 |
| Lorenzo Tuinaanleg en Bestratingen | Bovenkarspel | gidsvermelding, KvK 81650108 (2021) HERJAAGD 31-08 (lane D): idem; het websiteveld in de gids verwijst bovendien naar een ander bedrijf. | 2026-08-25, herjaagd 2026-08-31 |
...
Heeft wél een e-mailadres (`info@de-baard.nl`), maar dat adres wijst op
een eigen domein terwijl de kaart als opening gebruikt dat de zaak geen
eigen website heeft. Of `de-baard.nl` echt een site serveert, was vanaf
hier niet te controleren. De openingszin zou dus feitelijk onjuist kunnen
zijn, en dat is precies wat nooit mag. Kaart pas gebruiken nadat iemand
`de-baard.nl` in een browser heeft geopend; klopt het dat er geen site
staat, dan kan de kaart terug naar het bord.
...
| Autorijschool Kyra | Stein (LB) | Lane F 26-08. Opgericht 2022, eigenaar/instructeur Kyra Alberigs, Heisteeg 13, 06-36469177, eigen domein autorijschoolkyra.nl. Sterk groeifaseprofiel, 20 min van Maastricht. Geen e-mailadres in de zoekresultaten, alleen telefoon | 2026-08-26 |
| Motorrijschool Motodrome | Zwolle | Lane F 26-08. NIET dezelfde reden als de rijen hierboven: adres wél beweerd (`rijschoolmotodrome@gmail.com`, niet-gokbaar dus kansrijk) maar NIET te verifiëren — de egress-proxy blokkeerde elke pagina. Leeftijd en boekingssituatie ongecontroleerd | 2026-08-26 |
| Motorrijschool De Jong | Pernis (Rotterdam) | Lane F 26-08. Beweerd `motorrijschooldejong@hotmail.com` (niet-gokbaar), niet te verifiëren wegens geblokkeerd netwerk | 2026-08-26 |
| RWO Rijschool | Vianen | Lane F 26-08. Beweerd `ron@rworijschool.nl` (persoonsnaam, niet de standaardgok), niet te verifiëren wegens geblokkeerd netwerk | 2026-08-26 |
| Motorrijschool MOVICA | Hoofddorp/Haarlem | Lane F 26-08. Beweerd adres `Rijschooldetlef@gmail.com` draagt de naam van een ándere rijschool — vermoedelijk een verwisseling door de zoeksamenvatter. Eerst de naam vaststellen | 2026-08-26 |
...
| Zaanburg Koeltechniek | Zaandam | Sterkste profiel van de dag: KvK 84211903 (opgericht 21-10-2021), 4,9★/177 reviews Werkspot, 9,7 Trustoo, gedateerde review 18-06-2026. Alleen bereikbaar via Werkspot/Trustoo-leadformulieren, geen eigen domein of adres gevonden HERJAAGD 31-08 (lane D): het enige adres dat bij dit bedrijf bovenkomt is Info@nourkoeltechniek.nl van partnerbedrijf Nour Koeltechniek B.V. (Rechte Tocht 9H). Dat draagt de naam van een ander bedrijf en haalt de poort nooit — niet gebruiken. | 2026-08-28, herjaagd 2026-08-31 |
...
| SSD Stukadoor | Dordrecht | KvK 87931915, opgericht 21-10-2022, eenmanszaak, 1 werkzame persoon, Burgemeester de Raadtsingel 261 (3311 JH). Telefoonnummer staat wel in de gidsvermeldingen; website noch e-mailadres publiek bekend volgens meerdere bronnen. Het sterkste profiel van lane D 29-08 — jonge zaak zonder vindbare site, precies het primaire doelwit — en alleen op het adres gestrand HERJAAGD 31-08 (lane D): de eenbedrijfspagina van Compadex bij KvK 87931915 meldt expliciet dat er geen e-mailadres en geen website bekend is — negatief registerfeit, niet opnieuw jagen. | 2026-08-29, herjaagd 2026-08-31 |
| Diamant Dakbedekkingen | Zaandam | KvK 76535193, opgericht 29-11-2019, eenmanszaak van Misha Bos, Hogendijk 166A (1506 AM), eigen domein diamantdakbedekkingen.nl, Top Score 2026 op Dakdekkersgids, Werkspot-profiel met reviews, Facebookpagina. Geen e-mailadres publiek vermeld HERJAAGD 31-08 (lane D): opnieuw geen adres op eigen domein, Werkspot, Facebook of Dakdekkersgids. | 2026-08-29, herjaagd 2026-08-31 |
...
| Bedrijf | Plaats | Wat er wel is | Datum gecheckt |
|---|---|---|---|
| Hondentrimsalon Helen | Oterleek (gem. Alkmaar) | Helen Pouwels, Dorpsstraat 3, 1842 GS. Trimdiploma juni 2024, salon geopend **30-08-2024** — twee jaar, precies op profiel. Eigen domein hondentrimsalonhelen.nl. Lek in haar eigen woorden: een afspraak loopt via het contactformulier of WhatsApp. Vier ronden zonder adres én zonder telefoonnummer, dus ook geen bellijstregel | 2026-09-05 **06-09-2026 lane D, vijfde ronde:** geen adres. De eigen site zet uitdrukkelijk een contactformulier plus WhatsApp als route neer, en dat is een keuze en geen lacune — een salon die zo werkt, publiceert haar adres bewust niet. Belregel. |
...
| Glaswas Service Sijstermans | Valkenburg aan de Geul (LB) | eigen domein `glaswasservicesijstermans.nl` + Facebookpagina; KvK 86346105 (2022), vestigingsnummer 000052328724, Dr Ariënsstraat, Broekhem-Noord; eigenaren Ruben en Ramona Sijstermans. Leeftijd, eigen domein en klantenstopronde alle drie dicht — alleen het adres ontbreekt, na VIER onafhankelijk geformuleerde ronden (contact, exacte domeinronde, vrije-providerronde, klantenstopronde). Oozo, alleglazenwassers, nextdoor en transfirm voeren geen adres. **HERJACHT 10-09 (lane C): de Facebook-infobalkroute is nu OOK uitgesloten — vijf ronden in totaal.** De ronde die deze regel zelf voorstelde is gedraaid (`"Glaswas Service Sijstermans" Valkenburg e-mailadres OF mail OF gmail OF outlook OF hotmail`) en gaf zijn Facebookpagina terug zónder adres; oozo, alleglazenwassers, nextdoor en transfirm voeren het nog steeds niet. Klantenstopronde 10-09 opnieuw leeg, dus het profiel staat nog. Vestigingsnummer 000052328724 is een nieuwe waarneming voor de reeks van 1.35 en bevestigt 2022. Bij een volgende herjacht is er geen onuitgeputte zoekroute meer bekend: dit is een belregel geworden, niet een mailregel | 2026-09-08, herjacht 2026-09-10 |
...
| Tuinman Arno | Hollandscheveld (Hoogeveen, DR) | hovenier | KvK 90919289, opgericht 01-08-2023, De Oplegger 2 7913 RM, eenmanszaak. Op profiel qua leeftijd. Geen eigen domein. De samenvattende alinea bood tuinmanarno@gmail.com én 0629282590 aan; de verplichte exacte-tekenreeksronde (1.28) gaf NUL pagina's die dat adres dragen — alleen een persoonlijk LinkedIn-profiel, dat bovendien onder de privacyregel valt (zakelijke kanalen only). Contactgegevens uit die alinea zijn per 1.37 geen contactgegevens, dus ook het nummer is niet overgenomen | 2026-09-10 |
| Smit Groen Grond Infra | Hollandscheveld (Hoogeveen, DR) | hovenier | KvK 88597350 (2023), Riegshoogtendijk 53 7913 AA, eenmanszaak 1 werkzaam persoon. Op profiel qua leeftijd. Geen eigen domein; twee ronden gaven geen adres en geen nummer — de gidsen zetten het nummer achter "Telefoonnummer tonen" en daar gaat per order (2) van 09-09 geen derde ronde meer in. LET OP twee naamgenoten in hetzelfde dorp: Smits Groen (smitsgroen.nl) en Smit Dienstverlening | 2026-09-10 |
| Streutker tuin & infra | Hollandscheveld (Hoogeveen, DR) | hovenier | KvK 75128403 (2019), zeven jaar — de rand van het venster en op zichzelf geen afwijzing. Kerkenkavel 15 7913 AS. Geen eigen domein; telefoonnummer afgeschermd in telefoonboek.nl en oozo | 2026-09-10 |
| J. Dijkstra Dienstverlening | Bitgummole (Waadhoeke, FR) | glazenwasser | KvK 90263197, glazenwasser sinds 2023 volgens de alleglazenwassers-eenbedrijfspagina (vestiging 000056003722), Langestraat. Op profiel qua leeftijd. Geen eigen domein, nummer afgeschermd. LET OP de naamgenoten: W. Dijkstra Dienstverlening (Oosterwolde, eigen domein) en Dijkstra boom en groen (Opende, staat al in contacted.md) | 2026-09-10 |
| Schilderwerken Veendam | Veendam (GR) | schilder | KvK 97091685 (97-reeks, 2025) — één jaar, onderkant van het venster en geen tractie aangetoond. Eigen domein schilderwerkenveendam.nl met precies twee geïndexeerde pagina's (home en /over-ons/), gerund door Bas en Lianne. Twee ronden gaven geen e-mailadres en geen telefoonnummer, alleen een contactformulier. Ook poort (a) staat open | 2026-09-10 |
| Kitsune Cleaning | Haarlem (Indischewijk, NH) | glazenwasser | Eenbedrijfspagina alleglazenwassers.nl, vestigingsnummer 000053359178 (2022-band); twee ronden gaven geen eigen domein, geen adres, geen telefoon uit de bruikbare laag | 2026-09-10 |
| Rick Service | De Kwakel (gem. Uithoorn, NH) | glazenwasser | Eenbedrijfspagina alleglazenwassers.nl, vestigingsnummer 000051026678, Wijk 90 Glastuinbouwgebied; geen eigen domein | 2026-09-10 |
| The Smile Squad | Amsterdam (Slotervaart-Zuid, NH) | glazenwasser | Eenbedrijfspagina, vestigingsnummer 000060207434 (2024, op profiel); geen eigen domein. De gids voert drie activiteiten naast elkaar, dus wat de zaak doet staat niet vast | 2026-09-10 |
| Schoonmaakbedrijf Hv | Dordrecht (Industriegebied West, ZH) | glazenwasser | Eenbedrijfspagina, vestigingsnummer 000054455901 (2022); twee ronden gaven geen eigen domein | 2026-09-10 |
| Trimsalon Memikino | Hoogvliet Rotterdam (ZH) | hondentrimsalon | KvK 95914056, vestigingsnummer 000061283681 (2024/25, precies op profiel), Boerenhoek 38 3191 TC; twee ronden gaven geen eigen domein. Het duurste gemis van de hondensector op 10-09 | 2026-09-10 |
| De Mooiste honden en katten trimsalon | Zandvoort (NH) | honden-/kattentrimsalon | KvK 88732487, vestigingsnummer 000054573548 (2022), Oosterparkstraat 27 2042 AP; twee ronden gaven geen eigen domein | 2026-09-10 |
| De Rooseboom | Beverwijk (NH) | hovenier | Eenbedrijfspagina hovenier.website/beverwijk/de-rooseboom/; geen eigen domein. Gidsdatum niet gebruikt: per 1.18(b) vestigingsdatum, en zij komt uit de samenvattende alinea | 2026-09-10 |
| MvK tuinen | Haarlem (NH) | hovenier | Eenbedrijfspagina hovenier.website/haarlem/mvk-tuinen/; geen eigen domein | 2026-09-10 |
| Mhoveniers en tuinbestrating | Obdam (gem. Koggenland, NH) | hovenier | Eenbedrijfspagina hovenier.website/obdam/...; Kerkweg 22. LET OP: het telefoonnummer dat de zoekmachine aanbiedt staat uitsluitend in de samenvattende alinea en is per 1.20(a)/1.37 geen bron - daarom staat deze zaak hier en niet op bellijst.md | 2026-09-10 |
| Jaspers Bouwservice | Beverwijk (NH) | hovenier | Eenbedrijfspagina hovenier.website/beverwijk/jaspers-bouwservice/; geen eigen domein | 2026-09-10 |
| Hoveniersbedrijf Nick Dekkers | Zwanenburg (gem. Haarlemmermeer, NH) | hovenier | Eenbedrijfspagina hovenier.website/zwanenburg/...; geen eigen domein | 2026-09-10 |
| Kooijker Glasbewassing en Schoonmaakservice | Zwolle (OV) | glazenwasser | KvK 83108432 (2021), vestigingsnummer 000049302663, Voermanstraat 72, Facebookpagina; geen eigen domein, en één ronde gaf ook geen telefoonnummer | 2026-09-10 |
| Tim Glasbewassing | Enschede (OV) | glazenwasser | KvK 91841143, vestigingsnummer 000057498113, Oliemolensingel 84A; twee ronden waaronder een kale ronde op het vestigingsnummer gaven alleen registerprofielen, de gidsen schermen de contactgegevens af | 2026-09-10 |
| TUINENKENNIS | Arnhem (GLD) | hovenier | Alleen de gidsvermelding op hovenier.website (09-10-2023); één ronde gaf geen domein, geen adres, geen telefoon, geen KvK-nummer. Naam te generiek voor de index | 2026-09-10 |
| Vos Groen Adviseurs | Zeewolde (FL) | hovenier | Eigen domein vosgroenadviseurs.nl, Facebookpagina, Tarwelaan 106, gidsdatum 24-08-2022; één ronde gaf geen adres en geen KvK-nummer. LET OP: de naam botst met adviseur Kees Vos, een privépersoon | 2026-09-10 |
| Schildersbedrijf R. Treep | Zwolle (OV) | schilder | Alleen de gidsvermelding op schilder-nu.nl (30-01-2023); één ronde gaf niets erbuiten. De naam botst met Caravanstalling, Administratiekantoor en Hoveniersbedrijf Treep in dezelfde stad | 2026-09-10 |
| Basverfkwast | Nijmegen (GLD) | schilder | KvK 89827295, gestart 03-04-2023, eenmanszaak; één ronde gaf geen domein, geen adres, geen telefoonnummer | 2026-09-10 |
...
| Wonderschoon Glazenbewassing | Maastricht (LB) | glazenwasserij | **HERJAGEN — beste glazenwassersprofiel van de lane-regio zonder adres.** KvK 93680066 + vestigingsnummer 000059204737 op twee onafhankelijke citeerbare URL's (companyinfo en alleglazenwassers). 2024, twee jaar, één werkzaam persoon, Bogaartsborg, wijk De Heeg. Twee ronden gaven geen adres. **LET OP twee identiteitsvallen van 1.36:** wonderschoon-schoonmaak.nl is een ánder bedrijf, en wonderschoon.nl is een fabrikant van schoonmaakproducten met een 072-nummer (Noord-Holland). Geen van beide nummers hoort bij deze zaak | 2026-09-11 |
| De Glazenwasser 013 | Geleen (gem. Sittard-Geleen, LB) | glazenwasserij | KvK 89754190 in de companyinfo-URL, postcode 6166BH, 2023 (drie jaar), op profiel. Eén ronde gaf geen adres. **LET OP:** "013" is het netnummer van Tilburg terwijl de zaak in Geleen staat; 013glazenwasserij/schoonmaak in Tilburg (mail@013glazenwasserij.nl) is een ánder bedrijf | 2026-09-11 |
| BS cleaning | Venlo (LB) | glazenwasserij | KvK 93339305 + vestigingsnummer 000058891889 uit de companyinfo-URL, 2024, op profiel. **LET OP:** de adresronde levert info@bsreiniging.nl plus 06-45426638 op — dat is BS Reiniging, een Marktplaats-adverteerder in "centraal Nederland" en een ánder bedrijf. Niet overnemen | 2026-09-11 |
| Mister Fresh | Venlo (LB) | glazenwasserij | KvK 97094420 + vestigingsnummer 000062360523 uit de companyinfo-URL, 2025/26, onderkant van het venster. Eén ronde gaf geen enkele treffer buiten de registerpagina. LOOKALIKE: Mister Clean Schoonmaak & Glazenwasserij | 2026-09-11 |
| Dani's Dienstverlening | Tilburg (NB) | glazenwasserij | KvK 83605630 + vestigingsnummer 000049763482 uit de companyinfo-URL, 2021 (vijf jaar), postcode 5035AP. Eén ronde gaf geen eigen domein, geen adres en geen telefoon | 2026-09-11 |
| J&D Softwashreiniging | Waalwijk (NB) | gevelreiniging/softwash | KvK 94621926 uit de transfirm-URL, Grotestraat 345a 5142 CA, 2024/25, gerund door Daan en Julius. Eigen domein jdsoftwashreiniging.nl dat een echte site serveert, plus een Werkspot-profiel — maar twee ronden gaven geen e-mailadres en geen telefoonnummer. **LET OP 1.30:** een ronde geeft "4,2 uit 54.257 beoordelingen op Werkspot" terug; dat is het platformtotaal, niet zijn cijfer | 2026-09-11 |
| Lindersgroenwerken | Swolgen (gem. Horst aan de Maas, LB) | hovenier | KvK 82894299, opgericht 04-06-2021, Generaal Dempseystraat 6, één werkzaam persoon — vijf jaar, op profiel. Twee ronden gaven geen adres, geen telefoon, geen domein en geen Facebookpagina. LOOKALIKE: Weltensgroenwerken (Margraten) | 2026-09-11 |
| Tuinonderhoud Dieleman | Biervliet (gem. Terneuzen, ZL) | hovenier | KvK 90594193, opgericht 01-07-2023, Weststraat 4 4521 AX — drie jaar, op profiel. Eén ronde gaf geen adres en geen volledig telefoonnummer. **LET OP vier naamgenoten in hetzelfde dorp:** Maatschap F & J Dieleman, Onderhoudsbedrijf Dieleman, P. Dieleman en Dieleman Landbouw (KvK 84043059). Zoek altijd met "tuinonderhoud" erbij | 2026-09-11 |
...
| Trimsalon Tante Net | Leiden (ZH) | hondentrimsalon | Eigen domein trimsalontantenet.nl (EEN geindexeerde pagina, geen contactpagina), levend Instagram @trimsalon_tante_net met posts 02-07, 10-07 en 09-08-2026, drimble-nieuwsbericht over de opening. Sterk profiel, uitsluitend op afspraak = 549-lek. Twee adresronden leeg. Wie hem oppakt heeft een adresbron nodig die de zoekindex niet heeft | 2 | 2026-09-11 **VERPLAATST NAAR bellijst.md OP 11-09 DOOR AZZOUZ.** Poort (a) is gesloten op 09-08-2026 (instagram.com/trimsalon_tante_net/p/Db1M3rzFtZu/) en er is een telefoonnummer 06-15023047. Een zaak met een gedateerd levensteken en een bereikbare weg hoort op de bellijst en niet bij de onbereikbaren; deze regel blijft staan als spoor. **LANE D 12-09: de twee door Azzouz opgedragen ronden zijn gedraaid en allebei leeg (`site:trimsalontantenet.nl contact OR e-mail OR info` geeft alleen de homepage; `"tantenet.nl"` geeft nul pagina's op dat domein). Poort (b) is nu open na vijf ronden over drie diensten en het dossier is definitief een BELREGEL - niet opnieuw jagen.** |
| Sander schilderwerk en renovatie | Enschede (OV) | schilder | Eigen domein sanderschilderwerken-renovatie.nl (`/` en `/about/` geïndexeerd), Trustoo 8,9 en top-10 Enschede, Werkspot-profiel. Twee ronden gaven geen e-mailadres, geen telefoonnummer en geen KvK-nummer. Sterk lek, geen enkel kanaal | 2026-09-11 |
| SJ Totaal | Almere (De Wierden, FL) | glazenwasser | KvK 85273503 (2022), vestigingsnummer 000051326833, op leeftijd binnen het venster. Geen eigen domein; twee ronden zonder adres en zonder telefoon. Draagt zich ook als bouwbedrijf | 2026-09-11 |
| IJzerman Groot Groen Onderhoud | Lelystad (FL) | hovenier | KvK 90332601, 15-05-2023, Botter 24 25. Volledig op profiel qua leeftijd. Twee ronden melden uitdrukkelijk dat er geen telefoonnummer en geen e-mailadres bekend is; geen eigen domein | 2026-09-11 |
| F.Streefkerk allround | Lelystad (FL) | hovenier | KvK 89304640, 12-02-2023, Wittezeestraat 29 8226 BP. Geen contactgegevens bekend in twee ronden. Voert naast hovenier ook metaalbewerking en bouwklussen | 2026-09-11 |
...
| Mo Cleaning & Onderhoud | Delft (ZH) | glazenwasser | Vestigingsnummer 000051379481 en KvK 85328235, allebei uit de URL van de alleglazenwassers-eenbedrijfspagina; 2021/22-band en dus op profiel. Twee ronden: geen eigen domein, geen e-mailadres, geen telefoonnummer in de bruikbare laag. Order 7 van Azzouz, afgemaakt | 2026-09-12 |
| Just Groom Me | Alphen aan den Rijn (ZH) | hondentrimsalon | Sterk profiel en tóch geen adres: eigen domein justgroomme.nl met zeven geïndexeerde pagina's, eigenaar Ilona, Stationsplein 21 in Pet & Co, uitsluitend op afspraak (het 549-lek), platformronde schoon, klantenstopronde schoon. Twee adresronden leeg - de Shopify-vorm van de site laat geen adres in de index lekken. Wie hem oppakt heeft een adresbron nodig die de zoekindex niet heeft | 2026-09-12 |
## 12 september 2026 — lane C (Limburg, Noord-Brabant, Zeeland)

Vijf zaken, alle vijf met een eigen domein en alle vijf zonder openbaar e-mailadres.
Dat is de omkering van de meting van 06-09, waar vijf van vijf bedrijven mét eigen
domein hun adres in één ronde gaven — zie de bevinding in `2026-09-12-c.md`.
Trimsalon Pluishuis is de duurste van de vijf: zij haalt elke andere poort.

| Bedrijf | Plaats | Sector | Wat er wél is | Ronden | Datum |
|---|---|---|---|---|---|
| Trimsalon Pluishuis | Geleen (Sittard-Geleen, LB) | hondentrimsalon | Eigen domein trimsalonpluishuis.nl met /contact, /over-trimsalon-pluishuis en /dienstenentarieven. Eigenaresse Marloes Schelfhout, Nachtegaalstraat 48, KvK 92533183, mobiele doodletrimster aan huis. **Poort (a) dicht en hard (1.13):** de eigen tarievenpagina voert een verhoging van 7 euro per **1 augustus 2026**. Poort (f): haar eigen pagina meldt het eerste jaar van de salon. Klantenstopronde leeg. Contactroute is mail, app of social media — geen agenda, geen platform, dus het agendalek is echt. Géén telefoonnummer gevonden, dus ook geen belregel | 3 (`site:`-ronde, exacte tekenreeks `"@trimsalonpluishuis.nl"`, gerichte mail/gmail/outlook/hotmail-ronde op haar naam) | 2026-09-12 |
| Hondentrimsalon 't Hondenhofje | Sittard (LB) | hondentrimsalon | Eigen domein hondenhofje.nl met vier eigen pagina's, eigenaresse Sina. **De reden is technisch en nieuw voor dit bestand:** de contactpagina schermt de adressen af tegen spambots en toont ze pas via JavaScript, zodat er geen tekenreeks bestaat die een zoekmachine kan indexeren. Geen enkele exacte-tekenreeksronde kan hier ooit iets opleveren. LET OP: trimsalonweb voert hem onder Schinveld, de eigen site onder Sittard | 1 (`"Hondenhofje" Sittard trimsalon sinds contact e-mail tarieven wachtlijst`) | 2026-09-12 |
| Oes4fun | Oostburg (Sluis, ZL) | hondentrimsalon | Eigen domein oes4fun.nl, Elly Stokkerman-Gijs, Grote Beer 86 4501 ES, 0117-440110 en 06-22278940. Telefonisch bereikbaar; zodra er een gedateerd levensteken ligt is dit een belregel en geen parkeerregel | 1 | 2026-09-12 |
| TuinMensch | Venlo (LB) | hovenier | hovenier.website/venlo/tuinmensch/, KvK 85156612, eenmanszaak, gidsdatum 20-01-2022 (per 1.18b een vestigingsdatum). Op leeftijd op profiel. Geen eigen domein gevonden; het gidsprofiel is ongeclaimd en bevat per definitie geen adres (1.20b) | 1 | 2026-09-12 |
...
| André Tuinier Hovenier | Sneek (Fr) | hovenier | KvK 84942169 + vestigingsnummer 000051027925: 2022, vier jaar, gewoon op profiel. Facebookpagina, hovenier.website-eenbedrijfspagina, telefoonboek t8676188, hallohovenier. Twee ronden zonder adres. VAL: andretuinier.nl is een tuintipssite en NIET vastgesteld als zijn domein | 2026-09-13 |
| GJW Tuintechniek en infra | Drachten (Fr) | hovenier | KvK 87384787: 2022, vier jaar, gewoon op profiel. Hagewyk 86 staat alleen in de alinea. Telefoonboek t8889464, oozo, hovenier.website; geen eigen domein, één ronde zonder adres. VAL: gjwgroenservice.nl is een ANDERE naam | 2026-09-13 |
| Stukadoorsbedrijf Stucgoud | Groningen (Gr) | stukadoor | KvK 87352664: 2022, vier jaar, op profiel. Eigen domein stucgoud.nl waarvan alleen de homepage geïndexeerd is - het lek bestaat hier waarschijnlijk WEL, alleen het kanaal ontbreekt. Twee ronden, ook op de exacte tekenreeks "@stucgoud.nl". VAL: stucgoed.nl (info@stucgoed.nl) is een ANDER bedrijf, een groothandel | 2026-09-13 |
| Stucadoor Ton | De Groeve (Tynaarlo, Dr) | stukadoor | KvK 87380676: 2022, vier jaar, op profiel. Hunzeweg 51. Geen eigen domein; de stukadoorgids-eenbedrijfspagina nodigt de eigenaar uit zijn zaak te claimen. Geen adres, geen nummer in de bruikbare laag | 2026-09-13 |
| StedeGro Schilderwerken | Emmen (Dr) | schilder | KvK 95936238 + vestigingsnummer 000061305391: ±1 jaar, onderrand. Werkspot-profiel en een verse Facebookpagina, De Hietbrink 39; geen eigen domein, één ronde zonder adres | 2026-09-13 |
| Schildersbedrijf Amaro | Leeuwarden (Fr) | schilder | KvK 77801210: 2020, zes jaar, bovenrand van het profiel. schilder-nu.nl meldt uitdrukkelijk dat er geen website bekend is; oozo en telefoonboek t8078082 voeren hem. Eén ronde, geen adres; het 06-nummer stond alleen in de alinea | 2026-09-13 |
| Dakdekkers AE | Assen (Dr) | dakdekker | KvK 83500340: 2021, vijf jaar, gewoon op profiel. Hof van Parijs 13. Geen eigen domein; één ronde gaf zes landelijke 085-dakdekkerportalen en geen adres van deze zaak | 2026-09-13 |
...
| PUUR Hoveniers | regio Rijssen/Nijverdal (OV) | hovenier | 2026-09-13 lane B. Gevonden via een instagram-zeefronde; eigen account puurhoveniers bestaat. Twee ronden gaven GEEN eigen domein en GEEN e-mailadres. Het 0548-netnummer stond alleen in de samenvattende alinea en is per 1.37-analoog NIET opgeschreven. ZWARE LOOKALIKEFAMILIE die de zaak niet laat identificeren: puurtuin.nl, puur-tuinen.nl en puurnatuurhoveniers.nl zijn drie andere bedrijven. Leeftijd niet vastgesteld, want de identificatie ging eraan voorbij |
| Cura cleaning | Eerbeek (gem. Brummen, GLD) | glazenwasser | 2026-09-13 lane B. KvK 86536117 (86-reeks, 2022) + vestigingsnummer 000052506150 uit de alleglazenwassers-URL — OP LEEFTIJD GEWOON OP PROFIEL, vier jaar. Voert glazenwassen, interieurreiniging en gevelreiniging. Twee ronden (gerichte contactronde + gmail/hotmail/gidsenronde) gaven geen eigen domein, geen e-mailadres en geen telefoonnummer in de bruikbare laag. Haydnstraat 4. Dit dossier klopt op leeftijd en vak en valt uitsluitend op het kanaal |
| Stukadoorsbedrijf Van Elk | Arnhem (GLD) | stukadoor | 2026-09-13 lane B. KvK 83083529 uit de TransFirm-URL (83-reeks, ca. 2021) — BINNEN HET VENSTER. Kemperbergerweg 771. Twee ronden gaven geen eigen domein en geen e-mailadres; telefoonboek.nl/bedrijven/t8755807/arnhem/stukadoorsbedrijf-van-elk/ voert telefoon EN e-mail als 'Afgeschermd', dus er is ook geen belregel. LOOKALIKE bij een poort-(e)-ronde: 'Van Elk' treft in contacted.md Osmose-Telewash (ZH) en Trimsalon Het Hofje (NH) als substring |
