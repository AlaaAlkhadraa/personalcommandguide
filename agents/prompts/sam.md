...
QUOTA: minimum 10 prospects, each with a dated Actief: line and, wherever findable, a published email address (prefer prospects whose email IS findable — jouwweb/webnode sites leak emails to search, Wix does not).
