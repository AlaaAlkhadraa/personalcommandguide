...
- **Sam** (outreach, runs Thursday) — playbook: `agents/outreach-agent.md`
...
### 3. Write this week's orders -> `agents/directives.md`
...
### 4. Report to the owner -> `marketing/reports/YYYY-MM-DD.md`

A CEO report the owner can read in two minutes:

- **Shipped last week** — articles, packs, prospect counts, in numbers.
- **Review** — one short paragraph each on John's and Sam's quality.
- **Pipeline** — ledger totals: drafted / sent / replied.
- **This week's plan** — the directives, summarised.
...
End with the report's headline numbers and this week's directives in a
few lines: that is what the owner sees in the notification.
