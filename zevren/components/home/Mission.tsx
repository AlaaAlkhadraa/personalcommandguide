    ...
    <section className="relative overflow-hidden border-b border-white/5 py-16 lg:py-20">
      ...
      <Container className="relative grid items-center gap-10 lg:grid-cols-[1.15fr_1fr] lg:gap-16">
        ...
        <dl className="grid grid-cols-2 gap-x-6 gap-y-7 sm:grid-cols-4">
          {figures.map((figure) => (
            <div key={figure.label} className="flex flex-col gap-1 text-center sm:text-start">
              <dd className="font-heading text-3xl font-bold tabular-nums text-accent lg:text-[2.25rem]">
                {figure.value}
              </dd>
