...
const fr: Dictionary = {
  ...
  demos: {
    ...
    property: {
      ...
      heroBadge: "Plateforme locative",
      heroHeading: "Trouvez votre prochain chez-vous.",
      heroSubtitle: "Recherchez, filtrez et demandez une visite, le tout au même endroit.",
      searchPlaceholder: "Recherchez par ville ou mot-clé",
      searchButton: "Rechercher",
      anyLocation: "Tout emplacement",
      anyType: "Tout type",
      anyPrice: "Tout prix",
      resultsFound: "biens trouvés",
      ...
      selectDate: "Choisir une date",
      selectTime: "Choisir un horaire",
      requestViewingButton: "Demander une visite",
      viewingReceivedTitle: "Demande de visite reçue",
      viewingReceivedBody: "Nous examinerons votre demande et vous recontacterons.",
    },
    ellezone: {
      navShop: "Boutique",
