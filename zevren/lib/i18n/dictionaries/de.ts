...
const de: Dictionary = {
  ...
  home: {
    ...
    conceptCta: {
      title: "Noch keine Vorstellung, wie Ihre Website aussehen soll?",
      subtitle: "Wählen Sie Stil, Farben und Seiten und sehen Sie sofort eine Vorschau Ihrer Homepage.",
      button: "Eigenes Konzept bauen",
    },
    finalCta: {
  ...
  offer: {
    ...
    subtitle: "Wählen Sie das passende Paket. Was es kostet, steht auf der Karte.",
    body: "Jedes Paket wird von Grund auf rund um Ihr Unternehmen entworfen und gebaut. Sie kennen den Preis, bevor wir beginnen, und genau der steht auf der Rechnung.",
  ...
  work: {
    ...
    metaTitle: "{name}: Website für {category}",
    items: {
      "tajex-logistics": {
        category: "Logistik",
