...
const de: Dictionary = {
  ...
  demos: {
    ...
    property: {
      ...
      heroBadge: "Vermietungsplattform",
      heroHeading: "Finden Sie Ihr nächstes Zuhause.",
      heroSubtitle: "Suchen, filtern und eine Besichtigung anfragen, alles an einem Ort.",
      searchPlaceholder: "Suche nach Stadt oder Stichwort",
      searchButton: "Suchen",
      anyLocation: "Beliebiger Ort",
      anyType: "Beliebiger Typ",
      anyPrice: "Beliebiger Preis",
      resultsFound: "Immobilien gefunden",
      ...
      selectDate: "Datum wählen",
      selectTime: "Uhrzeit wählen",
      requestViewingButton: "Besichtigung anfragen",
      viewingReceivedTitle: "Besichtigungsanfrage erhalten",
      viewingReceivedBody: "Wir prüfen Ihre Anfrage und melden uns bei Ihnen.",
    },
    ellezone: {
      navShop: "Shop",
