...
const de: Dictionary = {
  ...
  insights: {
    eyebrow: "Insights",
    title: "Klare Antworten rund um Websites",
    subtitle: "Was Dinge kosten, was wirklich zählt und was warten kann. Geschrieben, wie wir mit Kunden sprechen: ohne Jargon, ohne Verkaufsgespräch.",
    readMore: "Artikel lesen",
    backToInsights: "Alle Insights",
    minuteRead: "Min. Lesezeit",
    englishNote: "Dieser Artikel ist auf Englisch verfügbar.",
    ctaEyebrow: "In die Praxis umsetzen",
    ctaTitle: "Lieber bauen lassen als darüber lesen?",
    ctaBody: "Erzählen Sie uns von Ihrem Projekt und wir melden uns mit einem klaren Plan und einem Festpreis.",
    ctaButton: "Projekt starten",
    metaTitle: "Insights",
    metaDescription: "Klare Antworten rund um Websites: Kosten, Geschwindigkeit, SEO und Onlineshops, ohne Jargon geschrieben von ZEVREN.",
  },
  footer: {
    description:
