...
export const TERMS: LegalContent = {
  ...
  ar: {
    ...
    metaDescription: "الشروط والأحكام المنطبقة على العروض والاتفاقيات مع ZEVREN.",
    blocks: [
      {
        type: "p",
        text: "تنطبق هذه الشروط والأحكام على جميع العروض والاتفاقيات والأعمال التي تنفذها {company} (السجل التجاري الهولندي، KvK {kvk})، ويشار إليها لاحقاً بـ ZEVREN.",
      },
      { type: "h2", text: "1. نطاق التطبيق" },
      {
        type: "p",
        text: "تنطبق هذه الشروط على كل عرض واتفاقية بين ZEVREN والعميل، ما لم يتفق الطرفان كتابياً على خلاف ذلك. وتُرفض صراحةً أي شروط شراء أو شروط أخرى يطرحها العميل.",
      },
      { type: "h2", text: "2. العروض ونشوء الاتفاقية" },
      {
        type: "p",
        text: "عروض ZEVREN غير ملزمة وصالحة لمدة 30 يوماً ما لم يُذكر خلاف ذلك. وتصبح الاتفاقية نافذة عندما يؤكد العميل العرض كتابياً، بما في ذلك عبر البريد الإلكتروني.",
      },
      { type: "h2", text: "3. تنفيذ الاتفاقية" },
      {
        type: "p",
        text: "تنفذ ZEVREN الاتفاقية على أفضل وجه ممكن. مواعيد التسليم المذكورة استرشادية ولا تشكّل موعداً نهائياً ملزماً ما لم يُتفق على ذلك صراحةً. ولا تتحمل ZEVREN مسؤولية التأخير الناتج عن عدم تزويد العميل بالمحتوى أو الملاحظات أو الموافقات في الوقت المناسب.",
      },
      { type: "h2", text: "4. الأسعار والدفع" },
      {
        type: "p",
        text: "جميع الأسعار باليورو ودون ضريبة القيمة المضافة ما لم يُذكر خلاف ذلك. وما لم يُتفق على غير ذلك، تفوتر ZEVREN نسبة 50% عند بدء المشروع و50% المتبقية عند التسليم. وتُدفع الفواتير خلال 14 يوماً من تاريخها؛ وعند تجاوز هذه المدة يُعد العميل في حالة تأخر تلقائياً وتستحق الفوائد التجارية القانونية.",
      },
      { type: "h2", text: "5. تعديلات المهمة (أعمال إضافية)" },
      {
        type: "p",
        text: "لا تُنفَّذ التعديلات التي يطلبها العميل على المهمة الأصلية إلا بعد موافقة كتابية على التكاليف الإضافية الناتجة وعلى أي تعديل في الجدول الزمني.",
      },
      { type: "h2", text: "6. الملكية الفكرية" },
      {
        type: "p",
        text: "بعد سداد كامل المبلغ، يحصل العميل على حق استخدام الموقع أو التطبيق المُسلَّم للغرض المتفق عليه. أما الشيفرة المصدرية والمكوّنات والأساليب التي كانت ملكاً لـ ZEVREN قبل بدء المشروع، أو القابلة لإعادة الاستخدام عموماً، فتبقى ملكاً لـ ZEVREN.",
      },
      { type: "h2", text: "7. الصيانة والضمان" },
      {
        type: "p",
        text: "بعد التسليم تسري فترة ضمان مدتها 30 يوماً، تصلح ZEVREN خلالها مجاناً أي خلل يثبت أنه ناتج عن أخطاء في التسليم. ولا يغطي هذا الضمان التعديلات التي يجريها العميل أو طرف ثالث بعد التسليم. وتُقدَّم الصيانة بعد هذه الفترة حصراً ضمن الاشتراك الموصوف أدناه.",
      },
      { type: "h2", text: "8. اشتراك الصيانة والاستضافة" },
      {
        type: "p",
        text: "اشتراك الصيانة والاستضافة اتفاقية منفصلة واختيارية إلى جانب بناء الموقع. ويُفوتر المبلغ شهرياً مقدماً ودون ضريبة القيمة المضافة.",
      },
      { type: "p", text: "يشمل الاشتراك:" },
      {
        type: "ul",
        items: [
          "استضافة الموقع وإدارة اسم النطاق",
          "النسخ الاحتياطي واستعادة الموقع عند الحاجة",
          "تحديثات الأمان وتحديثات البرمجيات",
          "تعديلات النصوص والصور بطلب من العميل، حتى ساعة واحدة في الشهر. ولا يُرحَّل الوقت غير المستخدم إلى الشهر التالي.",
        ],
      },
      {
        type: "p",
        text: "الصفحات الجديدة والميزات الجديدة وإعادة التصميم وأي عمل يتجاوز الساعة المشمولة تقع كلها خارج الاشتراك، وتُسعَّر على نحو منفصل قبل بدء العمل.",
      },
      { type: "h3", text: "8.1 المدة والإلغاء" },
      {
        type: "p",
        text: "الشهر الأول شهر تجريبي. يجوز للعميل إنهاء الاشتراك في أي وقت خلال هذا الشهر، كتابياً، دون إبداء سبب ودون أي رسوم إلغاء. ويكون الشهر الذي بدأ مستحق الدفع، ولا يُستحق أي مبلغ آخر.",
      },
      {
        type: "p",
        text: "إذا لم يُنهَ الاشتراك خلال الشهر التجريبي، تبدأ مدة 12 شهراً بعد انتهاء الشهر التجريبي. وبعد هذه المدة يستمر الاشتراك لأجل غير محدد، ويجوز لأي من الطرفين إنهاؤه كتابياً في أي وقت بإشعار مدته شهر واحد.",
      },
      { type: "h3", text: "8.2 ما يحصل عليه العميل" },
      {
        type: "p",
        text: "أياً كانت طريقة انتهاء الاشتراك ووقته، يحصل العميل على كل ما يتكوّن منه الموقع. يُسجَّل اسم النطاق باسم العميل حيثما يسمح المُسجِّل بذلك، ويُنقل إليه أو إلى المُسجِّل الذي يختاره دون أي رسوم. ويحصل العميل كذلك على ملفات الموقع. لا يُحتجز شيء كوسيلة ضغط، ولا توجد رسوم نقل أو خروج أو رسوم إدارية. وتستمر الاستضافة حتى نهاية الفترة المدفوعة ثم تتوقف.",
      },
      { type: "h3", text: "8.3 السعر والدفع" },
      {
        type: "p",
        text: "يجوز لـ ZEVREN تعديل المبلغ مرة واحدة في السنة الميلادية، بإشعار مسبق لا يقل عن شهر. وإذا لم يوافق العميل على المبلغ الجديد، جاز له إنهاء الاشتراك بتاريخ سريانه، بصرف النظر عن مدة الـ12 شهراً. وإذا بقيت الفاتورة دون سداد بعد تذكير و14 يوماً إضافية، جاز لـ ZEVREN تعليق الاشتراك حتى ورود الدفع؛ وقد يصبح الموقع خارج الخدمة خلال هذه الفترة. ولا يمس التعليق حق العميل في النطاق والملفات وفق البند 8.2.",
      },
      { type: "h2", text: "9. المسؤولية" },
      {
        type: "p",
        text: "تنحصر مسؤولية ZEVREN عن الأضرار الناتجة عن تنفيذ الاتفاقية في المبلغ المفوتر عن المهمة المعنية، وبحد أقصى 10,000 يورو. ولا تتحمل ZEVREN بأي حال المسؤولية عن الأضرار غير المباشرة، بما فيها الأرباح الفائتة والخسائر التبعية. ولا يسري هذا التحديد في حالات القصد أو الإهمال الجسيم من جانب ZEVREN.",
      },
      { type: "h2", text: "10. الإنهاء والفسخ" },
      {
        type: "p",
        text: "يجوز لأي من الطرفين إنهاء الاتفاقية كتابياً بإشعار معقول. وفي حالة الإنهاء المبكر، يلتزم العميل بدفع قيمة العمل المنفَّذ فعلاً بالسعر المتفق عليه.",
      },
      { type: "h2", text: "11. القانون الواجب التطبيق والنزاعات" },
      {
        type: "p",
        text: "يسري القانون الهولندي على جميع الاتفاقيات مع ZEVREN. وتُرفع النزاعات في الدرجة الأولى إلى المحكمة المختصة في إقليم ليمبورخ، ما لم ينص القانون الآمر على خلاف ذلك.",
      },
      { type: "h2", text: "تواصل معنا" },
      { type: "p", text: "لديك سؤال عن هذه الشروط؟ راسلنا على {email}." },
    ],
  },
};
