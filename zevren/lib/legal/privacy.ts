...
export const PRIVACY: LegalContent = {
  ...
  ar: {
    ...
    metaDescription: "كيف تتعامل ZEVREN مع البيانات الشخصية، بما يتوافق مع اللائحة العامة لحماية البيانات (GDPR).",
    blocks: [
      {
        type: "p",
        text: "{company} (ZEVREN، نحن)، ومقرها {city} في هولندا، هي المسؤولة عن معالجة البيانات الشخصية على النحو الموصوف في هذه السياسة. نلتزم باللائحة الأوروبية العامة لحماية البيانات (GDPR).",
      },
      { type: "h2", text: "ما البيانات التي نعالجها" },
      {
        type: "p",
        text: "عند تعبئة نموذج التواصل في هذا الموقع، نعالج البيانات التي تقدمها بنفسك: اسمك وبريدك الإلكتروني، واختيارياً اسم شركتك، ومحتوى رسالتك. لا نجمع من النموذج أي شيء غير ما تكتبه أنت.",
      },
      { type: "h2", text: "لماذا نعالج هذه البيانات" },
      {
        type: "p",
        text: "نستخدم هذه البيانات حصراً للرد على استفسارك، وإذا نتج عنه مشروع، لتنفيذ الاتفاقية معك. الأساس القانوني هو المادة 6(1)(ب) من اللائحة (تنفيذ عقد أو اتخاذ خطوات قبل إبرامه)، وعند الاقتضاء مصلحتنا المشروعة في الرد على استفسارات العملاء المحتملين.",
      },
      { type: "h2", text: "مدة الاحتفاظ" },
      {
        type: "p",
        text: "نحتفظ ببيانات نموذج التواصل لمدة أقصاها 24 شهراً من آخر تواصل، ما لم ينتج عنها اتفاقية. في تلك الحالة نحتفظ بها للمدة اللازمة لتنفيذ الاتفاقية، تُضاف إليها مدد الاحتفاظ القانونية اللاحقة، مثل الالتزام الضريبي الهولندي بحفظ السجلات المالية سبع سنوات.",
      },
      { type: "h2", text: "المشاركة مع أطراف ثالثة" },
      {
        type: "p",
        text: "لا نبيع البيانات الشخصية لأي طرف ثالث. ولتشغيل هذا الموقع وخدماتنا نستعين بعدد محدود من معالجي البيانات، مثل مزوّد الاستضافة (Vercel) وخدمة البريد لمعالجة رسائل النموذج (Resend). وتوجد اتفاقيات معالجة بيانات مبرمة مع هذه الأطراف حيثما تتطلب اللائحة ذلك.",
      },
      { type: "h2", text: "ملفات تعريف الارتباط وإحصاءات الزوار" },
      {
        type: "p",
        text: "نضع ملفّي تعريف ارتباط دون طلب الموافقة، لأن الموقع لا يعمل من دونهما: أحدهما يحفظ اللغة التي اخترتها، والآخر يحفظ إجابتك عن سؤال ملفات تعريف الارتباط أدناه. لا يعرّف أي منهما هويتك ولا يتتبعك إلى موقع آخر.",
      },
      {
        type: "p",
        text: "لمعرفة عدد زوار الموقع والصفحات التي يقرؤونها، نستخدم Vercel Web Analytics. تعمل هذه الخدمة دون ملفات تعريف ارتباط ودون بصمة جهاز: لا يُعرَّف أي زائر ولا يُتتبَّع بين المواقع، ولا يمكن رد البيانات إليك. ولا تتطلب موافقة، وهي مفعّلة للجميع.",
      },
      {
        type: "p",
        text: "نعلن عبر Google. ولمعرفة أي إعلان أدى إلى طلب فعلي، نستخدم قياس التحويلات من Google Ads، وهو يضع بالفعل ملف تعريف ارتباط. لا يحدث ذلك إلا بعد ضغطك على أوافق في الشريط أسفل الصفحة. وحتى ذلك الحين، وبشكل دائم إذا ضغطت أرفض، تعمل الأداة وجميع الإشارات الإعلانية معطلة: لا يُحفظ شيء على جهازك ولا يُقرأ أي معرّف. نحتفظ باختيارك ستة أشهر، ويعمل الموقع بالطريقة نفسها في الحالتين. وإذا أردت تغيير رأيك، فاحذف ملف تعريف الارتباط zevren_consent من متصفحك وسيُطرح السؤال من جديد.",
      },
      { type: "h2", text: "مساعد الدردشة" },
      {
        type: "p",
        text: "في الموقع مساعد دردشة يجيب عن الأسئلة المتعلقة بخدماتنا وأسعارنا. تُرسل الرسائل التي تكتبها هناك إلى Anthropic، مزوّد الذكاء الاصطناعي الذي يولّد الإجابات، وتُعالج ضمن اتفاقية معالجة بيانات. لا نستخدمها لغير الرد عليك، ولا تُحفظ المحادثة على جهازك، ولا تحتاج إلى حساب. لا تكتب في الدردشة بيانات شخصية مثل عنوانك أو معلومات الدفع؛ استخدم لذلك نموذج التواصل أو راسلنا على {email}.",
      },
      { type: "h2", text: "الأمان" },
      {
        type: "p",
        text: "نتخذ تدابير تقنية وتنظيمية مناسبة لحماية البيانات الشخصية من الضياع أو المعالجة غير المشروعة، منها الاتصالات المشفّرة (HTTPS)، وتقييد الوصول إلى البيانات، والتحديثات الأمنية المستمرة للأنظمة التي نستخدمها.",
      },
      { type: "h2", text: "حقوقك" },
      {
        type: "p",
        text: "يحق لك الاطلاع على بياناتك الشخصية وتصحيحها وطلب حذفها، كما يحق لك الاعتراض على المعالجة أو طلب تقييدها. للقيام بذلك راسلنا على {email}. ويحق لك أيضاً تقديم شكوى إلى الهيئة الهولندية لحماية البيانات (Autoriteit Persoonsgegevens).",
      },
      { type: "h2", text: "التعديلات" },
      {
        type: "p",
        text: "قد نحدّث هذه السياسة من وقت إلى آخر، وتجد النسخة الأحدث دائماً في هذه الصفحة.",
      },
      { type: "h2", text: "تواصل معنا" },
      {
        type: "p",
        text: "لديك سؤال عن سياسة الخصوصية؟ راسلنا على {email} أو اتصل على {phone}.",
      },
    ],
  },
};
